...
class Beginnersolve extends StatefulWidget {
  const Beginnersolve({Key? key}) : super(key: key);

  @override
  _BeginnersolveState createState() => _BeginnersolveState();
}

class _BeginnersolveState extends State<Beginnersolve> {
  late ConfettiController _confettiController;
  List<int> selectedImages = [];
  List<int> correctAnswers = [1, 4, 6];
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: screenSize.height * 0.2,
                  child: Text(
                    'CHOOSE THE JARS THAT IS MOST CERTAIN TO PICK AN APPELE',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.getFont(
                      'Calistoga',
                      color: const Color(0xFF000181),
                      fontSize: screenSize.width*0.035*0.8,
