...
class likely5 extends StatefulWidget {
  const likely5({Key? key}) : super(key: key);

  @override
  _likely5 createState() => _likely5();

}

class _likely5 extends State<likely5> {
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: screenSize.height * 0.2,
                  child: Text(
                    'HOW LIKELY IS IT TO PICK A MANGO?',
                    ...
                    child: isTappedList[1]
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'There is equal amount of fruits',
                            textAlign: TextAlign.center,
                            style: GoogleFonts.getFont(
                              'Calistoga',
                    ...
                    child: isTappedList[4]
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'more apples then mangoes in the jar!',
                            textAlign: TextAlign.center,
                            style: GoogleFonts.getFont(
                              'Calistoga',
                              color: const Color(0xFFFF2828),
